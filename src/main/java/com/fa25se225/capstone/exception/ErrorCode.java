...
public enum ErrorCode {
    ...
    INVALID_SINGLE_QUESTION_V2(1085, "Single question must have answers" , HttpStatus.BAD_REQUEST),
    INVALID_SUB_QUESTION_V2(1085, "Sub-question must have answers" , HttpStatus.BAD_REQUEST);
