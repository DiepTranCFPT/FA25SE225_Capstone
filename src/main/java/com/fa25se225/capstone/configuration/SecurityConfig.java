...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS_GET = {"auth/forgot-password", "test/**", "learning-materials/public","/payment/momo/**", "exam-templates/browse", "exam-templates/ratings/**", "users/teachers", "/questions-v2/import/template", "/flashcard-sets","/{fileName}/materials"};
