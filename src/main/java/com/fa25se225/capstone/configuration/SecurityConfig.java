...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS_POST = {"/users", "auth/token", "auth/introspect", "auth/logout", "auth/refresh-token", "auth/reset-password/**", "test/**","/auth/verify-email","/auth/outbound/authentication"};
